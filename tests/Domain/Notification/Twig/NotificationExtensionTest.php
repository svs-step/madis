...
class NotificationExtensionTest
{
    ...
    public function setUp(): void
    {
        ...
        $this->translatorProphecy->trans('label.de')->willReturn('de');
        $this->translatorProphecy->trans('label.par')->willReturn('par');
        $this->translatorProphecy->trans('label.du')->willReturn('du');
