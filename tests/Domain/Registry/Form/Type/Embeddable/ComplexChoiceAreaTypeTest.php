...
class ComplexChoiceAreaTypeTest extends FormTypeHelper
{
    public function testInstanceOf(): void
    {
        $this->assertInstanceOf(AbstractType::class, new ComplexChoiceAreaType());
    }
    ...
    public function testBuildForm(): void
    {
        ...
        (new ComplexChoiceAreaType())->buildForm($this->prophesizeBuilder($builder), []);
    }
