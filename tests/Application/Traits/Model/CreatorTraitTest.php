...
class CreatorTraitTest extends TestCase
{
    /**
    ...
    public function testPropertyExistence()
    {
        ...
        $this->assertTrue(\property_exists($object, 'creator'));
    }
    ...
    public function testMethodsExistence()
    {
        ...
        $this->assertTrue(\method_exists($object, 'getCreator'));
        $this->assertTrue(\method_exists($object, 'setCreator'));
    }
}
