 ...
 */
final class Version20200512143335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conformite_traitement_reponse_action_protection (conformite_traitement_reponse_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', mesurement_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_A4EBC0E4A812C2AB (conformite_traitement_reponse_id), INDEX IDX_A4EBC0E42EA38911 (mesurement_id), PRIMARY KEY(conformite_traitement_reponse_id, mesurement_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE conformite_traitement_reponse_action_protection ADD CONSTRAINT FK_A4EBC0E4A812C2AB FOREIGN KEY (conformite_traitement_reponse_id) REFERENCES conformite_traitement_reponse (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE conformite_traitement_reponse_action_protection DROP FOREIGN KEY FK_A4EBC0E4A812C2AB');
