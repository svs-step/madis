 ...
 */
final class Version20200728144749 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registry_conformite_organisation_evaluation DROP created_at, DROP updated_at');
    }
}
