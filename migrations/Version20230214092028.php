...
final class Version20230214092028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel_answer CHANGE referentiel_question_id referentiel_question_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('ALTER TABLE referentiel_answer ADD CONSTRAINT FK_A20038B0A4406355 FOREIGN KEY (referentiel_question_id) REFERENCES referentiel_question (id)');
        $this->addSql('ALTER TABLE referentiel_question DROP FOREIGN KEY FK_4CA5FDC6F800C8E');
        $this->addSql('ALTER TABLE referentiel_question CHANGE referentiel_section_id referentiel_section_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE option_reason option_reason VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE referentiel_question ADD CONSTRAINT FK_4CA5FDC6F800C8E FOREIGN KEY (referentiel_section_id) REFERENCES referentiel_section (id)');
        $this->addSql('ALTER TABLE referentiel_section DROP FOREIGN KEY FK_AD6EC056805DB139');
        $this->addSql('ALTER TABLE referentiel_section CHANGE referentiel_id referentiel_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('ALTER TABLE referentiel_section ADD CONSTRAINT FK_AD6EC056805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel_answer DROP FOREIGN KEY FK_A20038B0A4406355');
        $this->addSql('ALTER TABLE referentiel_answer CHANGE referentiel_question_id referentiel_question_id CHAR(36) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE referentiel_question DROP FOREIGN KEY FK_4CA5FDC6F800C8E');
        $this->addSql('ALTER TABLE referentiel_question CHANGE referentiel_section_id referentiel_section_id CHAR(36) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:uuid)\', CHANGE option_reason option_reason VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE referentiel_section DROP FOREIGN KEY FK_AD6EC056805DB139');
        $this->addSql('ALTER TABLE referentiel_section CHANGE referentiel_id referentiel_id CHAR(36) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:uuid)\'');
