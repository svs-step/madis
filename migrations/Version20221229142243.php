...
final class Version20221229142243 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE referentiel_answer (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', answer_number INT NOT NULL, referentiel_question_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, recommendation VARCHAR(255) NOT NULL, option_not_concerned TINYINT(1) NOT NULL, INDEX IDX_A20038B0A4406355 (referentiel_question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE referentiel_question (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', question_number INT NOT NULL, referentiel_section_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, weight INT NOT NULL, INDEX IDX_4CA5FDC6F800C8E (referentiel_section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
