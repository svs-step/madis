...
final class Version20230221141253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE maturity ADD referentiel_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', DROP domain_id, CHANGE survey_id survey_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE maturity_answer ADD recommendation VARCHAR(255) NOT NULL, ADD name VARCHAR(255) NOT NULL, ADD position INT NOT NULL, DROP survey_id, CHANGE question_id question_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
