    ...
    public function referentielsDatatablesAction()
    {
        ...
        foreach ($referentiels as $referentiel) {
            ...
            if ((!\is_null($authorizedCollectivityTypes)
                ...
                $reponse['data'][] = [
                    'name'        => '<div class="radio"><label class="required" for="' . $referentiel->getId() . '"><input type="radio" id="' . $referentiel->getId() . '" value="' . $referentiel->getId() . '" name="referentiel_choice" required="true"/> ' . $referentiel->getName() . '</label></div>',
