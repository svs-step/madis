...
class SurveyReferentielSection
{
    /**
     * @var UuidInterface
     */
    ...
    /**
     * @var iterable|SurveyReferentielQuestion[]
     */
    private $surveyReferentielQuestions;

    /**
     * @var iterable|SurveyReferentiel
     */
    public $surveyReferentiel;
    /**
     * @var int|null
     */
    public $orderNumber;
    ...
    public function getSurveyReferentielQuestions(): ?iterable
    {
        return $this->referentielQuestions;
    }

    public function setSurveyReferentielQuestions(?SurveyReferentielQuestion $surveyReferentielQuestion): void
    {
