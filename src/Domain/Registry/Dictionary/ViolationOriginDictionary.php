...
class ViolationOriginDictionary extends SimpleDictionary
{
    ...
    public static function getOrigins()
    {
        return [
            ...
            self::ORIGIN_TRASH_CONFIDENTIAL_DOCUMENT => 'Mise au rebus de documents papier contenant des données personnelles sans destruction physique',
            self::ORIGIN_TRASH_CONFIDENTIAL_DEVICE   => 'Mise au rebus d’appareils numériques contenant des données personnelles sans effacement sécurisé',
